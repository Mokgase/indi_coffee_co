    ...
    <div id="termsandconditions" className="max-w-3xl mx-auto p-6 text-gray-800">
      ...
      <div className="mt-6">
        ...
        <ul className="list-disc pl-5">
          <li><strong>Company, we, us, or our</strong> refers to Indi Coffee Co, headquartered in Johannesburg, Gauteng.</li>
          <li><strong>You or User</strong> refers to any individual or entity accessing our services.</li>
          <li><strong>Services</strong> refers to all creative and artistic works, including digital art, visual media, and multimedia experiences provided by Indi Coffee Co.</li>
        </ul>
      </div>
      ...
      <div className="mt-6">
        ...
        <p>All content, trademarks, logos, and works displayed on our platform are owned by Indi Coffee Co or its licensors. Unauthorized reproduction, distribution, or modification of any content is strictly prohibited.</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <p>Indi Coffee Co provides its services as is without warranties of any kind. We are not liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use our services.</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <ul className="list-disc pl-5">
          <li><strong>Indi Coffee Co</strong></li>
          <li>Website: <a href="https://indicoffeeco.co.za" className="text-blue-600 underline">https://indicoffeeco.co.za</a></li>
